...
# =============================================================================
# Zupee OpenClaw - End-to-End Setup
# Provisions everything needed to run OpenClaw in Docker with SSH gateway
# =============================================================================
...
if id "$OPENCLAW_USER" &>/dev/null; then
    ...
    if [[ "$confirm" =~ ^[Yy]$ ]]; then
        ...
        if [[ "$(uname)" == "Darwin" ]]; then
            ...
            sudo dscl . -create /Users/$OPENCLAW_USER RealName "OpenClaw Bot"
...
# OpenClaw SSH hardening - auto-generated by setup.sh
...
echo "  Version:    OpenClaw $OPENCLAW_VERSION"
