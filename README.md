...
Claw connects to Slack via OpenClaw's native plugin using Socket Mode (real-time WebSocket). Traffic is routed through a Squid proxy that only allows `*.slack.com`. See [docs/slack-integration.md](docs/slack-integration.md) for setup.
